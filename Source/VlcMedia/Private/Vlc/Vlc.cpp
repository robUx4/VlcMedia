...
VLC_DEFINE(MediaPlayerTogglePause)
...
bool FVlc::Initialize()
{
	...
	VLC_IMPORT(libvlc_media_player_get_rate, MediaPlayerGetFps)
	...
	VLC_IMPORT(libvlc_media_player_pause, MediaPlayerTogglePause)
	VLC_IMPORT(libvlc_media_player_play, MediaPlayerPlay)
	VLC_IMPORT(libvlc_media_player_set_pause, MediaPlayerSetPause)
	VLC_IMPORT(libvlc_media_player_stop_async, MediaPlayerStop)
	...
	VLC_IMPORT(libvlc_track_description_list_release, TrackDescriptionListRelease)
